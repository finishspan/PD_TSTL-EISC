function [U, A, H, report] = convsparseFF(G,iH,method,iters,lambda)
...
%     B = B + V - A;
    ...
    Btmp2 = B + V - A;
    Vtmp1=V;
    Vtmp2= Pr.fh(A-Btmp2,abs(A-Btmp2)); % Lp norm
    B=Btmp1-1*(Btmp1-Btmp2);
    V=Vtmp1-1*(Vtmp1-Vtmp2);
...
function minHstep
    ...
    for i=1:maxiter_H
         ...
         % C = C + W - TH;   
         Wtmp2=projSphere(W);
         C=Ctmp1-1*(Ctmp1-Ctmp2);
         W=Wtmp1-1*(Wtmp1-Wtmp2); 
        %calcE;
    end
